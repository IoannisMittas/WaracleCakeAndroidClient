...
- If third party libraries were allowed, I would use Picasso or Glide for image processing,okhttp3 for network calls,
  and maybe guava for this line of code: byte[] bytes = ByteStreams.toByteArray(inputStream); :)
